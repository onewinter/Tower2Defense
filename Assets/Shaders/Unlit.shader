...
Shader "Archanor/VarietyFX/Unlit"
{
	Properties
	{
		...
		_SoftParticleFactor("Soft Particle Factor", Range( 0 , 1)) = 0.25
		[ASEEnd][Toggle(_SOFTPARTICLESTOGGLE_ON)] _SoftParticlesToggle("Soft Particles Toggle", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _SOFTPARTICLESTOGGLE_ON
			...
			UNITY_INSTANCING_BUFFER_START(ArchanorVarietyFXUnlit)
				UNITY_DEFINE_INSTANCED_PROP(float, _SoftParticleFactor)
			UNITY_INSTANCING_BUFFER_END(ArchanorVarietyFXUnlit)
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode8 = tex2D( _BaseMap, texCoord16 );
				
				float4 screenPos = IN.ase_texcoord4;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth2_g3 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth2_g3 = abs( ( screenDepth2_g3 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				float _SoftParticleFactor_Instance = UNITY_ACCESS_INSTANCED_PROP(ArchanorVarietyFXUnlit,_SoftParticleFactor);
				#ifdef _SOFTPARTICLESTOGGLE_ON
				float staticSwitch11 = ( tex2DNode8.a * saturate( ( distanceDepth2_g3 * (0.0 + (_SoftParticleFactor_Instance - 1.0) * (1.0 - 0.0) / (0.0 - 1.0)) ) ) );
				#else
				...
				float3 Color = ( ( IN.ase_color * _Intensity * _Color ) * tex2DNode8 ).rgb;
				float Alpha = staticSwitch11;
...
/*ASEBEGIN
Version=19002
216;776;1552;647;1905.372;502.2193;1.720975;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-1105.336,-29.34172;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;8;-876.0341,-57.47355;Inherit;True;Property;_BaseMap;Base Map;0;0;Create;True;0;0;0;False;0;False;-1;None;34ee712eac30f2743aa26638ec8bbbcd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;18;-734.5381,236.1369;Inherit;False;SoftParticle;3;;3;19addd00aa315e34a8023a9501be0858;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-490.2754,210.6092;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-474.2235,-251.7405;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;14;-710.9557,-532.0067;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;11;-341.1187,139.3039;Inherit;False;Property;_SoftParticlesToggle;Soft Particles Toggle;5;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-229.3377,-75.52685;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;5;-767.1537,-243.7292;Inherit;False;Property;_Color;Color;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;11.31371,11.31371,11.31371,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;6;-833.5903,-327.4174;Inherit;False;Property;_Intensity;Intensity;1;0;Create;True;0;0;0;False;0;False;1;1;0;25;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=367A6671BF54A4F0AF33D50DCDAE7083017B0AC2